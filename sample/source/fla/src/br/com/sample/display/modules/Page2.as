package br.com.sample.display.modules 
{
	 ...
	 */
	public class Page2 extends SexPage
	{
		...
		override public function init():void 
		{
			...
			var textClass:Class = ApplicationDomain.currentDomain.getDefinition("Page2Text") as Class;
			_text = new textClass() as Sprite;
			
			addChild( getAsset("image" ) );
			_text.y = getAsset("image" ).height + 5;
			addChild( _text );
			configColorMenu();
		...
		private function configColorMenu():void
		{
			...
			colorMenu.y = _text.y + _text.height + 5;
			addChild( colorMenu );
